...
class ChatModelEcoLogits(AbstractChatModel):
    def __init__(
        self,
        model_name,
        api_key=None,
    ...
    def __call__(self, messages: list[dict], n_samples: int = 1, temperature: float = None) -> dict:
        ...
        for itr in range(self.max_retry):
            ...
            try:
                ...
                #TODO: Handle error
                print("Eco logits calculation failed, Retry API-Call")
        ...
        if n_samples == 1:
            ...
            return res, completion.impacts
        else:
            return [AIMessage(c.message.content) for c in completion.choices], completion.impacts
...
class OpenAIChatModel(ChatModelEcoLogits):
    def __init__(
        self,
        model_name,
        api_key=None,
...
class OpenRouterChatModel(ChatModelEcoLogits):
    def __init__(
        self,
        model_name,
        api_key=None,
...
class AzureChatModel(ChatModelEcoLogits):
    def __init__(
        self,
        model_name,
        api_key=None,
...
# TODO: Implement this correctly for eco logits
...
class VLLMChatModel(ChatModelEcoLogits):
    def __init__(
        self,
        model_name,
        api_key=None,
